...
@Component({
  ...
  template: `
    <div
      ...
      class="bg-transparent dark:text-slate-50 text-slate-600 rounded-full inline-flex items-center transition-all duration-300 ease-in-out delay-0 hover:scale-[1.1]"
    >
      @if(icon(); as icon){
      <svg [attr.viewBox]="icon.viewBox" [class]="cssClass()">
        ...
        <linearGradient
          ...
          [attr.x2]="lgData.x2"
          [attr.y2]="lgData.y1"
          [attr.gradientTransform]="lgData.gradientTransform"
