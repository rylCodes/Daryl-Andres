  ...
  template: `
    ...
    >
      <div class="w-full max-w-7xl px-4 mx-auto">
        <!-- Title skeleton -->
        <div
          class="heading w-48 h-8 bg-slate-800 rounded-lg mx-auto mb-12 animate-pulse"
        ></div>
            ...
            <div class="flex flex-col md:flex-row">
              ...
              <div class="w-full md:w-1/2 p-6 flex flex-col justify-between">
                ...
                <div class="space-y-2 mb-6">
                  ...
                  ></div>
                  <div
                    class="h-4 bg-slate-700 rounded w-5/6 animate-pulse"
                  ></div>
                  <div
                    class="h-4 bg-slate-700 rounded w-4/6 animate-pulse"
                  ></div>
                </div>
